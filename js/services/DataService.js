...
import { ProductType, Category, SubCategory, StockStatus, Brand, BallMaterial } from '../enums/Enums.js';
...
import { Ball } from '../models/products/balls/Ball.js';
...
class DataService {
    ...
    _initData() {
        ...
        const dumbbells = [
            ...
            new FixedDumbbell({ name: 'دمبل فشرده ۱ کیلویی', price: 258000, stockStatus: StockStatus.AVAILABLE, weight: 1, unit: 'جفت', image: 'images/product-1.svg' }),
            new FixedDumbbell({ name: 'دمبل فشرده ۱.۵ کیلویی', price: 401000, stockStatus: StockStatus.AVAILABLE, weight: 1.5, unit: 'جفت', image: 'images/product-1.svg' }),
            new FixedDumbbell({ name: 'دمبل فشرده ۲ کیلویی', price: 528000, stockStatus: StockStatus.AVAILABLE, weight: 2, unit: 'جفت', image: 'images/product-1.svg' }),
            new FixedDumbbell({ name: 'دمبل فشرده ۲.۵ کیلویی', price: 415000, stockStatus: StockStatus.AVAILABLE, weight: 2.5, unit: 'جفت', image: 'images/product-1.svg' }),
            new FixedDumbbell({ name: 'دمبل فشرده ۳ کیلویی', price: 480000, stockStatus: StockStatus.AVAILABLE, weight: 3, unit: 'جفت', image: 'images/product-1.svg' }),
            new FixedDumbbell({ name: 'دمبل فشرده ۴ کیلویی', price: 670000, stockStatus: StockStatus.AVAILABLE, weight: 4, unit: 'جفت', image: 'images/product-1.svg' }),
            new FixedDumbbell({ name: 'دمبل فشرده ۵ کیلویی', price: 830000, stockStatus: StockStatus.AVAILABLE, weight: 5, unit: 'جفت', image: 'images/product-1.svg' }),
            new FixedDumbbell({ name: 'دمبل فشرده ۱۰ کیلویی', price: 910000, stockStatus: StockStatus.AVAILABLE, weight: 10, unit: 'جفت', image: 'images/product-1.svg' }),
            new FixedDumbbell({ name: 'دمبل فشرده ۱۳ کیلویی', price: 1000000, stockStatus: StockStatus.AVAILABLE, weight: 13, unit: 'جفت', image: 'images/product-1.svg' }),
            new FixedDumbbell({ name: 'دمبل فشرده ۱۷ کیلویی', price: 1450000, stockStatus: StockStatus.AVAILABLE, weight: 17, unit: 'جفت', image: 'images/product-1.svg' }),
            new FixedDumbbell({ name: 'دمبل فشرده ۲۰ کیلویی', price: 1600000, stockStatus: StockStatus.AVAILABLE, weight: 20, unit: 'جفت', image: 'images/product-1.svg' }),
            new FixedDumbbell({ name: 'دمبل فشرده ۲۵ کیلویی', price: 1850000, stockStatus: StockStatus.LIMITED, weight: 25, unit: 'جفت', image: 'images/product-1.svg' }),
            new FixedDumbbell({ name: 'دمبل فشرده ۳۳ کیلویی', price: 2350000, stockStatus: StockStatus.LIMITED, weight: 33, unit: 'جفت', image: 'images/product-1.svg' }),
            new FixedDumbbell({ name: 'دمبل فشرده ۴۲ کیلویی', price: 1270000, stockStatus: StockStatus.LIMITED, weight: 42, unit: 'جفت', image: 'images/product-1.svg' }),
            // دمبل بانوان
            new FixedDumbbell({ name: 'دمبل بانوان ۱ کیلویی (جفت)', price: 258000, stockStatus: StockStatus.AVAILABLE, weight: 1, unit: 'جفت', image: 'images/product-2.svg' }),
            new FixedDumbbell({ name: 'دمبل بانوان ۱.۵ کیلویی (جفت)', price: 401000, stockStatus: StockStatus.AVAILABLE, weight: 1.5, unit: 'جفت', image: 'images/product-2.svg' }),
            new FixedDumbbell({ name: 'دمبل بانوان ۲ کیلویی (جفت)', price: 528000, stockStatus: StockStatus.AVAILABLE, weight: 2, unit: 'جفت', image: 'images/product-2.svg' }),
            new FixedDumbbell({ name: 'دمبل بانوان ۲.۵ کیلویی (جفت)', price: 415000, stockStatus: StockStatus.AVAILABLE, weight: 2.5, unit: 'جفت', image: 'images/product-2.svg' }),
            new FixedDumbbell({ name: 'دمبل بانوان ۳ کیلویی (جفت)', price: 480000, stockStatus: StockStatus.AVAILABLE, weight: 3, unit: 'جفت', image: 'images/product-2.svg' }),
            new FixedDumbbell({ name: 'دمبل بانوان ۴ کیلویی (جفت)', price: 670000, stockStatus: StockStatus.AVAILABLE, weight: 4, unit: 'جفت', image: 'images/product-2.svg' }),
            new FixedDumbbell({ name: 'دمبل بانوان ۵ کیلویی (جفت)', price: 830000, stockStatus: StockStatus.AVAILABLE, weight: 5, unit: 'جفت', image: 'images/product-2.svg' }),
            new FixedDumbbell({ name: 'دمبل بانوان ۱۰ کیلویی (جفت)', price: 910000, stockStatus: StockStatus.AVAILABLE, weight: 10, unit: 'جفت', image: 'images/product-2.svg' }),
            // دمبل فشرده جدید
            new FixedDumbbell({ name: 'دمبل فشرده ۳۳ کیلویی (جدید)', price: 1650000, stockStatus: StockStatus.LIMITED, weight: 33, unit: 'جفت', image: 'images/product-1.svg' }),
        ];
        ...
        const balls = [
            // ----- توپ فوتبال (۱۸ عدد) -----
            new FootballBall({ name: 'توپ فوتبال بتا', price: 190000, stockStatus: StockStatus.AVAILABLE, brand: Brand.BETA, image: 'images/product-3.svg' }),
            new FootballBall({ name: 'توپ فوتبال بتا تنبل', price: 190000, stockStatus: StockStatus.AVAILABLE, brand: Brand.BETA, image: 'images/product-3.svg' }),
            new FootballBall({ name: 'توپ فوتبال مولتن سایز ۵ چرم', price: 1150000, stockStatus: StockStatus.AVAILABLE, brand: Brand.MOLTEN, image: 'images/product-3.svg' }),
            new FootballBall({ name: 'توپ فوتبال ایران مات', price: 190000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, image: 'images/product-3.svg' }),
            new FootballBall({ name: 'توپ فوتبال براق', price: 225000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, image: 'images/product-3.svg' }),
            new FootballBall({ name: 'توپ فوتبال دستی', price: 5000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, image: 'images/product-3.svg' }),
            new FootballBall({ name: 'توپ فوتسال مولتن', price: 1160000, stockStatus: StockStatus.AVAILABLE, brand: Brand.MOLTEN, image: 'images/product-3.svg' }),
            new FootballBall({ name: 'توپ فوتبال مولتن سایز ۵ چرم (جدید)', price: 1150000, stockStatus: StockStatus.AVAILABLE, brand: Brand.MOLTEN, image: 'images/product-3.svg' }),
            new FootballBall({ name: 'توپ فوتبال ایران مات (جدید)', price: 190000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, image: 'images/product-3.svg' }),
            new FootballBall({ name: 'توپ فوتبال براق (جدید)', price: 225000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, image: 'images/product-3.svg' }),
            new FootballBall({ name: 'توپ فوتبال مولتن سایز ۴ چرم', price: 980000, stockStatus: StockStatus.AVAILABLE, brand: Brand.MOLTEN, image: 'images/product-3.svg' }),
            new FootballBall({ name: 'توپ فوتبال مولتن سایز ۳ چرم', price: 850000, stockStatus: StockStatus.AVAILABLE, brand: Brand.MOLTEN, image: 'images/product-3.svg' }),
            new FootballBall({ name: 'توپ فوتبال ایران مات سایز ۵', price: 190000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, image: 'images/product-3.svg' }),
            new FootballBall({ name: 'توپ فوتبال ایران براق سایز ۵', price: 225000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, image: 'images/product-3.svg' }),

            // ----- توپ بسکتبال (۱۰ عدد) -----
            new BasketballBall({ name: 'توپ بسکتبال بتا', price: 155000, stockStatus: StockStatus.AVAILABLE, brand: Brand.BETA, image: 'images/product-4.svg' }),
            new BasketballBall({ name: 'توپ بسکتبال فوکسی', price: 150000, stockStatus: StockStatus.AVAILABLE, brand: Brand.FOX, image: 'images/product-4.svg' }),
            new BasketballBall({ name: 'توپ بسکتبال خارجی', price: 55000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IMPORTED, image: 'images/product-4.svg' }),
            new BasketballBall({ name: 'توپ بسکتبال فوکسی (جدید)', price: 150000, stockStatus: StockStatus.AVAILABLE, brand: Brand.FOX, image: 'images/product-4.svg' }),
            new BasketballBall({ name: 'توپ بسکتبال بتا (جدید)', price: 155000, stockStatus: StockStatus.AVAILABLE, brand: Brand.BETA, image: 'images/product-4.svg' }),
            new BasketballBall({ name: 'توپ بسکتبال سایز ۶', price: 145000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, image: 'images/product-4.svg' }),
            new BasketballBall({ name: 'توپ بسکتبال سایز ۷', price: 160000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, image: 'images/product-4.svg' }),
            new BasketballBall({ name: 'توپ بسکتبال فوکسی سایز ۶', price: 140000, stockStatus: StockStatus.AVAILABLE, brand: Brand.FOX, image: 'images/product-4.svg' }),

            // ----- توپ والیبال (۲۰ عدد) -----
            new VolleyballBall({ name: 'توپ والیبال فوکسی', price: 1100000, stockStatus: StockStatus.AVAILABLE, brand: Brand.FOX, image: 'images/product-5.svg' }),
            new VolleyballBall({ name: 'توپ والیبال مولتن زنبوری', price: 380000, stockStatus: StockStatus.AVAILABLE, brand: Brand.MOLTEN, image: 'images/product-5.svg' }),
            new VolleyballBall({ name: 'توپ والیبال مولتن زنبوری ایرانی', price: 220000, stockStatus: StockStatus.AVAILABLE, brand: Brand.MOLTEN, image: 'images/product-5.svg' }),
            new VolleyballBall({ name: 'توپ والیبال میکاسا اصلی ۲۰۰', price: 10000000, stockStatus: StockStatus.LIMITED, brand: Brand.MIKASA, image: 'images/product-5.svg' }),
            new VolleyballBall({ name: 'توپ والیبال میکاسا کپی', price: 700000, stockStatus: StockStatus.AVAILABLE, brand: Brand.MIKASA, image: 'images/product-5.svg' }),
            new VolleyballBall({ name: 'توپ والیبال گلدکاپ', price: 300000, stockStatus: StockStatus.AVAILABLE, brand: Brand.GOLD_CUP, image: 'images/product-5.svg' }),
            new VolleyballBall({ name: 'توپ والیبال ایرانی وی ۲۰۰ سبز', price: 160000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, image: 'images/product-5.svg' }),
            new VolleyballBall({ name: 'توپ والیبال ایرانی وی ۲۰۰', price: 155000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, image: 'images/product-5.svg' }),
            new VolleyballBall({ name: 'توپ والیبال مولتن زنبوری (جدید)', price: 380000, stockStatus: StockStatus.AVAILABLE, brand: Brand.MOLTEN, image: 'images/product-5.svg' }),
            new VolleyballBall({ name: 'توپ والیبال گلدکاپ (جدید)', price: 300000, stockStatus: StockStatus.AVAILABLE, brand: Brand.GOLD_CUP, image: 'images/product-5.svg' }),
            new VolleyballBall({ name: 'توپ والیبال فوکسی (جدید)', price: 1100000, stockStatus: StockStatus.AVAILABLE, brand: Brand.FOX, image: 'images/product-5.svg' }),
            new VolleyballBall({ name: 'توپ والیبال میکاسا اصلی ۳۰۰', price: 12000000, stockStatus: StockStatus.LIMITED, brand: Brand.MIKASA, image: 'images/product-5.svg' }),
            new VolleyballBall({ name: 'توپ والیبال مولتن زنبوری سایز ۵', price: 380000, stockStatus: StockStatus.AVAILABLE, brand: Brand.MOLTEN, image: 'images/product-5.svg' }),
            new VolleyballBall({ name: 'توپ والیبال مولتن زنبوری سایز ۴', price: 320000, stockStatus: StockStatus.AVAILABLE, brand: Brand.MOLTEN, image: 'images/product-5.svg' }),
            new VolleyballBall({ name: 'توپ والیبال ایرانی وی ۳۰۰', price: 180000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, image: 'images/product-5.svg' }),
            new VolleyballBall({ name: 'توپ والیبال ایرانی وی ۴۰۰', price: 200000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, image: 'images/product-5.svg' }),

            // ----- توپ هندبال (۵ عدد) -----
            new Ball({ name: 'توپ هندبال بتا', price: 130000, stockStatus: StockStatus.AVAILABLE, brand: Brand.BETA, category: Category.HANDBALL_BALL, size: 3, material: BallMaterial.PU, sport: 'هندبال', image: 'images/product-5.svg' }),
            new Ball({ name: 'توپ هندبال مولتن', price: 180000, stockStatus: StockStatus.AVAILABLE, brand: Brand.MOLTEN, category: Category.HANDBALL_BALL, size: 3, material: BallMaterial.PU, sport: 'هندبال', image: 'images/product-5.svg' }),
            new Ball({ name: 'توپ هندبال بتا (جدید)', price: 130000, stockStatus: StockStatus.AVAILABLE, brand: Brand.BETA, category: Category.HANDBALL_BALL, size: 3, material: BallMaterial.PU, sport: 'هندبال', image: 'images/product-5.svg' }),
            new Ball({ name: 'توپ هندبال مولتن (جدید)', price: 180000, stockStatus: StockStatus.AVAILABLE, brand: Brand.MOLTEN, category: Category.HANDBALL_BALL, size: 3, material: BallMaterial.PU, sport: 'هندبال', image: 'images/product-5.svg' }),

            // ----- توپ بدنسازی (۳۵ عدد) -----
            new ExerciseBall({ name: 'توپ بدنسازی ۷۵ ساده', price: 250000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 75, hasSpikes: false, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی ۷۵ خاردار', price: 375000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 75, hasSpikes: true, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی ۸۵ ساده', price: 485000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 85, hasSpikes: false, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی ۸۵ خاردار', price: 630000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 85, hasSpikes: true, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی ۶۵ ساده', price: 350000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 65, hasSpikes: false, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی ۶۵ خاردار', price: 425000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 65, hasSpikes: true, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی ۵۵ ساده', price: 280000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 55, hasSpikes: false, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی ۵۵ خاردار', price: 340000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 55, hasSpikes: true, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی ۴۵ ساده', price: 220000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 45, hasSpikes: false, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی ۴۵ خاردار', price: 270000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 45, hasSpikes: true, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی دسته دار ۸۰۰ گرمی', price: 280000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 30, hasSpikes: false, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ تعادل کوچک', price: 105000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 30, hasSpikes: false, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ استار تنبل', price: 430000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 65, hasSpikes: false, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ مولتن تنبل', price: 500000, stockStatus: StockStatus.AVAILABLE, brand: Brand.MOLTEN, diameter: 65, hasSpikes: false, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی ۷۵ خاردار (جدید)', price: 650000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 75, hasSpikes: true, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی ۸۵ ساده (جدید)', price: 485000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 85, hasSpikes: false, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی ۶۵ ساده (جدید)', price: 350000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 65, hasSpikes: false, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی ۷۵ ساده (جدید)', price: 250000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 75, hasSpikes: false, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی ۸۵ خاردار (جدید)', price: 630000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 85, hasSpikes: true, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی ۶۵ خاردار (جدید)', price: 425000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 65, hasSpikes: true, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی ۵۵ ساده (جدید)', price: 280000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 55, hasSpikes: false, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی ۵۵ خاردار (جدید)', price: 340000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 55, hasSpikes: true, image: 'images/product-6.svg' }),
            new ExerciseBall({ name: 'توپ بدنسازی ۴۵ ساده (جدید)', price: 220000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, diameter: 45, hasSpikes: false, image: 'images/product-6.svg' }),

            // ----- مدیسین بال (۱۰ عدد) -----
            new MedicineBall({ name: 'مدیسین بال ۱ کیلویی', price: 230000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, weight: 1, image: 'images/product-6.svg' }),
            new MedicineBall({ name: 'مدیسین بال ۲ کیلویی', price: 235000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, weight: 2, image: 'images/product-6.svg' }),
            new MedicineBall({ name: 'مدیسین بال ۳ کیلویی', price: 240000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, weight: 3, image: 'images/product-6.svg' }),
            new MedicineBall({ name: 'مدیسین بال ۴ کیلویی', price: 245000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, weight: 4, image: 'images/product-6.svg' }),
            new MedicineBall({ name: 'مدیسین بال ۵ کیلویی', price: 280000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, weight: 5, image: 'images/product-6.svg' }),
            new MedicineBall({ name: 'مدیسین بال ۱ کیلویی (جدید)', price: 332000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, weight: 1, image: 'images/product-6.svg' }),
            new MedicineBall({ name: 'مدیسین بال ۲ کیلویی (جدید)', price: 235000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, weight: 2, image: 'images/product-6.svg' }),
            new MedicineBall({ name: 'مدیسین بال ۳ کیلویی (جدید)', price: 240000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, weight: 3, image: 'images/product-6.svg' }),
            new MedicineBall({ name: 'مدیسین بال ۴ کیلویی (جدید)', price: 245000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, weight: 4, image: 'images/product-6.svg' }),
            new MedicineBall({ name: 'مدیسین بال ۵ کیلویی (جدید)', price: 280000, stockStatus: StockStatus.AVAILABLE, brand: Brand.IRANIAN, weight: 5, image: 'images/product-6.svg' }),
